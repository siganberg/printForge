      ...
      try {
        ...
        if (parsed?.print?.command === 'push_status') {
          ...
          const printerData = {
            ...
            // Layer information (A1 uses root level, X1 Carbon uses 3D nested)
            layerNum: parsed.print?.layer_num || parsed.print?.['3D']?.layer_num || 0,
            totalLayerNum: parsed.print?.total_layer_num || parsed.print?.['3D']?.total_layer_num || 0,
